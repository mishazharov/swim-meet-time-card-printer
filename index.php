			...
			<div class='jumbotron'>
				...
				<div class='row'>
					<div class='col-md-12 col-sm-12 col-lg-12'>
						<p class='text-center' style="font-size:15px">Hi swimmers, please use this form to log into the website, if you forgot your password, click <em><a href='/reset.php'>this link</a></em></p>
					</div>
				</div>
			</div>
		</div>
